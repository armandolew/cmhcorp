					...
					<div class="col-md-8 col-md-offset-2">
					  <div class="panel panel-default">
					    <div class="panel-heading">
		                 ...
		                 <form:form action="/medem/updateArea" method="POST" id="editAreaForm" modelAttribute="Area">
		                    <div class="form-group">
		                      <form:label path="name">Nombre del area</form:label>
		                      <form:input path="name" class="form-control required-text" placeholder="Nombre del área" />

	              	        ...
	              	        <div class="col-md-4">
	              	        	<div class="card">
	              	              ...
	              	              <div class="caption">
	              	              	  ...
	              	              	  <p><span class="text-muted">Tensión arterial: </span>${medicalHistory.physicalExploration.bloodPressure}</p>
	              	              	  ...
	              	              	  <p><span class="text-muted">Inspección general: </span><br/>${medicalHistory.physicalExploration.general}</p>
	              	              	  ...
	              	              	  <p><span class="text-muted">Abdómen: </span><br/>${medicalHistory.physicalExploration.abdomen}</p>
